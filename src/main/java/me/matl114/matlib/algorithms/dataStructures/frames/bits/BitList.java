...
public class BitList {
    ...
    private static final long[] BIT_TRUE_MASK = IntStream.range(0,64).mapToLong(i-> 1L <<i).toArray();
    private static final long[] BIT_FALSE_MASK = IntStream.range(0,64).mapToLong(i-> ~(1L <<i)).toArray();
