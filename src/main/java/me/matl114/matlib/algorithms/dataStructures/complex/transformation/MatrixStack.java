package me.matl114.matlib.algorithms.dataStructures.complex.transformation;
...
public class MatrixStack {
    ...
    public void pop(){
        Preconditions.checkState(stack.size() > 1, "Illegal State to MatrixStack! Pop action before you push!(async access?)");
        stack.removeLast();
    }
