...
public class ScreenUtils {
    public static final ItemStack PREV_BUTTON_ACTIVE = new CleanItemStack( Material.LIME_STAINED_GLASS_PANE, "&r⇦ Previous Page", new String[0]);
    public static final ItemStack NEXT_BUTTON_ACTIVE = new CleanItemStack(Material.LIME_STAINED_GLASS_PANE, "&rNext Page ⇨", new String[0]);
