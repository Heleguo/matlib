...
//    }
    ...
    public void testASM() throws Throwable{
        ...
        String generatedName = DemoBase.class.getName().replace("DemoBase","DemoDerivative" +new Random().nextInt(336));
        cw.visit(
            reader.readShort(6),
        ...
        var methodVisitor = cw.visitMethod(Opcodes.ACC_PUBLIC, "<init>", "()V", null, null);
        {
            ...
            methodVisitor.visitMethodInsn(Opcodes.INVOKESPECIAL, DemoBase.class.getName().replace(".","/"), "<init>", "()V", false);
        ...
        ClassVisitor writer = new MyClassVisitor(589824, cw,"loadMappingsIfPresent", DemoBase.class.getName().replace(".","/") );
