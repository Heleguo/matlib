...
import me.matl114.matlib.utils.registry.impl.RegistryImpl;
...
public class RegistryTests implements TestCase {
    ...
    public  NamespacedRegistry<Shit, ShitOwner> ROOT = new NamespacedRegistryImpl<>("matlib","shit-registry", true, new NamespacedKey("matlib", "0"));
    {
        Shit shit0 = new Shit();
