...
public class CraftBukkitUtilTests implements TestCase {
    ...
    public void test_tagcompoundView() throws Throwable{
        ...
        AssertEq(container.get(Slimefun.getItemDataService().getKey(), PersistentDataType.STRING), SlimefunItems.TRASH_CAN.getItemId());
        ...
        ItemUtils.setPersistentDataContainer(stack2, container,  0);
        container.set(Slimefun.getItemDataService().getKey(), PersistentDataType.STRING,"SHIT_TRASH_222");
        AssertEq(Slimefun.getItemDataService().getItemData(stack2).orElse(null), "SHIT_TRASH_222");
        container.set(Slimefun.getItemDataService().getKey(), PersistentDataType.STRING,"SHIT_TRASH");
        ItemUtils.setPersistentDataContainer(stack2, container,  1);
        container.set(Slimefun.getItemDataService().getKey(), PersistentDataType.STRING,"SHIT_TRASH_222");
