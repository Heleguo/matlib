...
import me.matl114.matlib.nmsMirror.impl.NMSServer;
...
public class ComponentTests implements TestCase {
    ...
    public void test_component(){
        ...
        String t1 = "Hello {entity:ababab}, your score is {0}! && {text: &aGreen &cRed{click_suggest:ababab?{click_placeholder}}} §#FF0000 &x&6&6&6&6&6&6CustomColor {player_placeholder} is here. translate test{translatable:&a&lme.matl114.test.message1$fallback{hover_text:try_inner?}}{hover_text:&6&lcdcdcd{hover_placeholder}{player_placeholder}}";
        ...
        Map<String, String> arguments = Map.of("0", "first parameter", "player_placeholder","test-fucking-player-name", "hover_placeholder","test-fucking-hover-placeholder", "click_placeholder","test-fucking-click-placeholder");
