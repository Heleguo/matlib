...
public class TypeOps implements DynamicOps<Object> {
    ...
    public DataResult<Boolean> getBooleanValue(Object input){
        return input instanceof Boolean bool ? DataHelper.A.I.success(bool): DataHelper.A.I.error(()->"not a boolean");
    }
    ...
    public DataResult<Stream<Pair<Object, Object>>> getMapValues(Object object) {
        ...
        return object instanceof Map<?,?> map0 ? DataHelper.A.I.success( map0.entrySet().stream().map(entry -> Pair.of(entry.getKey(), entry.getValue()))): DataHelper.A.I.error(()->"not a map");
    }
    @Override
    ...
    public DataResult<Stream<Object>> getStream(Object object) {
        return object instanceof List list0 ? DataHelper.A.I.success(list0.stream()) : DataHelper.A.I.error(()->"Not a list");
    }
