...
public class StyleBuilder implements Cloneable, BuildResult<Object>{
    ...
    public Object toNMS(){
        return FORMAT.newStyle(this.color, this.bold, this.italic, this.underlined, this.strikethrough, this.obfuscated, this.clickEvent, this.hoverEvent,  this.insertion, this.font);
    }
