...
public interface PacketType {
    ...
    String ClientboundSetCursorItemPacket =
        "Lnet/minecraft.network/protocol/game/ClientboundSetCursorItemPacket;";

    String ServerboundContainerClickPacket =
        "Lnet/minecraft.network/protocol/game/ServerboundContainerClickPacket;";
    ...
    String ClientboundSetEquipmentPacket =
        "Lnet/minecraft.network/protocol/game/ClientboundSetEquipmentPacket;";

    String ClientboundContainerSetContentPacket =
        "Lnet/minecraft.network/protocol/game/ClientboundContainerSetContentPacket;";
    String ClientboundSetEntityDataPacket =
        "Lnet/minecraft.network/protocol/game/ClientboundSetEntityDataPacket;";

    String ClientboundMerchantOffersPacket =
        "Lnet/minecraft.network/protocol/game/ClientboundMerchantOffersPacket;";
