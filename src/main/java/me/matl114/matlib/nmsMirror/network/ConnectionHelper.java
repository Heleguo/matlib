...
//    public void setListener(SimpleChannelInboundHandler<?> conn, @RedirectType(PacketListener)Object listener);
    ...
    @MethodTarget
    public void send(SimpleChannelInboundHandler<?> conn, @RedirectType(Packet)Object packet,@RedirectType(PacketSendListener)Object post);

    //having versioned problem
//    @MethodTarget
//    public void send(SimpleChannelInboundHandler<?> conn, @RedirectType(Packet)Object packet,@RedirectType(PacketSendListener)Object post, boolean flush);
...
//    public void flushChannel(SimpleChannelInboundHandler<?> conn);
    ...
    @MethodTarget(isStatic = true)
    ChannelFuture connect(InetSocketAddress address, boolean useEpoll, @RedirectType(Connection) SimpleChannelInboundHandler<?> conn);
