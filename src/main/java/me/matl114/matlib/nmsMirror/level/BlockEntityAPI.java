...
public interface BlockEntityAPI extends TargetDescriptor {
    ...
    boolean hopper$canTakeItemFromContainer(@RedirectType(Container)Object hopper, @RedirectType(Container)Object from, @RedirectType(ItemStack)Object itemStack, int slot, @RedirectType(Direction)Object facing);

    @MethodTarget(isStatic = true)
    @RedirectClass(HopperBlockEntityClass)
    @RedirectName("hopperPull")
    boolean hopper$hopperPull(@RedirectType(Level)Object level, @RedirectType("Lnet/minecraft/world/level/block/entity/Hopper;")Object hopper, @RedirectType(Container)Object container, @RedirectType(ItemStack)Object itemStack, int index);

    @MethodTarget(isStatic = true)
    @RedirectClass(HopperBlockEntityClass)
    @RedirectName("tryMoveInItem")
    Object hopper$tryMoveInItem(@RedirectType(Container)Object from, @RedirectType(Container)Object to, @RedirectType(ItemStack)Object item, int slot, @RedirectType(Direction)Object direction);
