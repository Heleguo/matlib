...
public interface ComponentTagHelper extends TargetDescriptor, TagHelper {
    @ConstructorTarget
    Object newComp();
    ...
    @MethodTarget
    @Contract("_,_ -> param1")
    public Object merge(Object nbt,@RedirectType(NbtCompound) Object otherNbt);
