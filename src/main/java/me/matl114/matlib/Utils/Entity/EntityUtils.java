...
public class EntityUtils {
    ...
    public static boolean executeOnSameEntity(Entity entity, Consumer<Entity> execution){
        ...
        return !entity.getLocation().getChunk().getWorld().getNearbyEntities(entity.getLocation(),0.25,0.25,0.25,(entity1 -> {
            if(entity1!=null && entity1.isValid() && entity.getUniqueId().equals( entity1.getUniqueId())){
                execution.accept(entity1);
                return true;
            }
            return false;
        })).isEmpty() || executeOnSameEntity(entity.getUniqueId(), execution);
    }
