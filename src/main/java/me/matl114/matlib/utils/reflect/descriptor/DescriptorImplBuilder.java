...
import me.matl114.matlib.utils.reflect.classBuild.ClassBuildUtils;
...
import static me.matl114.matlib.utils.reflect.classBuild.ClassBuildUtils.*;
...
public class DescriptorImplBuilder {
    ...
    private static Pair<Field,Boolean> matchFields(Method fieldAccess, List<Field> fields){
        return ClassBuildUtils. matchFields(fieldAccess, fields, fieldAccess.getAnnotation(FieldTarget.class).isStatic());
    }
    private static List<Method> matchMethods(Method methodAccess, List<Method> methods){
        return ClassBuildUtils. matchMethods(methodAccess, methods, methodAccess.getAnnotation(MethodTarget.class).isStatic(),true);
    }
