...
@Internal
@Note("this is a sample of how to use helper annotations, also this class is used internally for building Helpers for reobf")
...
//    public Object newInstance0(String obfName, String mojangName, Map mapping);
    ...
    @MethodTarget
    public Map methodsByObf(@RedirectType("Lio/papermc/paper/util/ObfHelper$ClassMapping")@Note("type redirect on self object can be ignored, but those on other argument should be processed and method should involve class cast") Object self);
