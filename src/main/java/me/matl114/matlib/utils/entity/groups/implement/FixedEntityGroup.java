...
public class FixedEntityGroup<T extends Entity,W extends Entity > extends ListedEntityGroup<T> {
    ...
    public static <R extends Entity,S extends Entity> FixedEntityGroupBuilder<R,S> builder(String namespace, S parent, boolean temp){
        return new FixedEntityGroupBuilder<R,S>(namespace,parent).temp(true);
    }
    public static <R extends Entity,S extends Entity> FixedEntityGroupBuilder<R,S> builder(Plugin namespace, S parent, boolean temp){
        return new FixedEntityGroupBuilder<R,S>(namespace,parent).temp(true);
    }
