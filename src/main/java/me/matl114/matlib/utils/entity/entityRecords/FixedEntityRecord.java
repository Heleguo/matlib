...
@Note("This kind of EntityRecord represents a fixed Entity, which do not move its Location,so when chunk unload,you can load it via recorded location")
@Getter
@AllArgsConstructor
public class FixedEntityRecord<T extends Entity> implements EntityRecord<T> {
    ...
    @Nullable
    public static EntityRecord<?> ofFixedEntity(UUID uuid) {
